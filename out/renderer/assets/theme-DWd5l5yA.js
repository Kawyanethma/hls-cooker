...
const s = { hasBackground: { default: true }, appearance: { default: "inherit" }, accentColor: { default: "indigo" }, grayColor: { default: "auto" }, panelBackground: { default: "translucent" }, radius: { default: "medium" }, scaling: { default: "100%" } };
const d = () => {
...
R.displayName = "Theme";
const I = reactExports.forwardRef((a2, s$1) => {
  const { appearance: r = s.appearance.default, accentColor: c = s.accentColor.default, grayColor: l = s.grayColor.default, panelBackground: p = s.panelBackground.default, radius: n = s.radius.default, scaling: t = s.scaling.default, hasBackground: i = s.hasBackground.default, ...u } = a2, [h, m] = reactExports.useState(r);
  reactExports.useEffect(() => m(r), [r]);
  const [y2, g] = reactExports.useState(c);
  reactExports.useEffect(() => g(c), [c]);
  const [v, C] = reactExports.useState(l);
  reactExports.useEffect(() => C(l), [l]);
  const [k, f] = reactExports.useState(p);
  reactExports.useEffect(() => f(p), [p]);
  const [B, x] = reactExports.useState(n);
  reactExports.useEffect(() => x(n), [n]);
  const [T, b] = reactExports.useState(t);
  return reactExports.useEffect(() => b(t), [t]), reactExports.createElement(A, { ...u, ref: s$1, isRoot: true, hasBackground: i, appearance: h, accentColor: y2, grayColor: v, panelBackground: k, radius: B, scaling: T, onAppearanceChange: m, onAccentColorChange: g, onGrayColorChange: C, onPanelBackgroundChange: f, onRadiusChange: x, onScalingChange: b });
});
I.displayName = "ThemeRoot";
const A = reactExports.forwardRef((a$1, s$1) => {
  const r = reactExports.useContext(P), { asChild: c, isRoot: l, hasBackground: p, appearance: n = r?.appearance ?? s.appearance.default, accentColor: t = r?.accentColor ?? s.accentColor.default, grayColor: i = r?.resolvedGrayColor ?? s.grayColor.default, panelBackground: u = r?.panelBackground ?? s.panelBackground.default, radius: h = r?.radius ?? s.radius.default, scaling: m = r?.scaling ?? s.scaling.default, onAppearanceChange: y$1 = d, onAccentColorChange: g = d, onGrayColorChange: v = d, onPanelBackgroundChange: C = d, onRadiusChange: k = d, onScalingChange: f = d, ...B } = a$1, x = c ? Slot : "div", T = i === "auto" ? a(t) : i, b = a$1.appearance === "light" || a$1.appearance === "dark", S = p === void 0 ? l || b : p;
  return reactExports.createElement(P.Provider, { value: reactExports.useMemo(() => ({ appearance: n, accentColor: t, grayColor: i, resolvedGrayColor: T, panelBackground: u, radius: h, scaling: m, onAppearanceChange: y$1, onAccentColorChange: g, onGrayColorChange: v, onPanelBackgroundChange: C, onRadiusChange: k, onScalingChange: f }), [n, t, i, T, u, h, m, y$1, g, v, C, k, f]) }, reactExports.createElement(x, { "data-is-root-theme": l ? "true" : "false", "data-accent-color": t, "data-gray-color": T, "data-has-background": S ? "true" : "false", "data-panel-background": u, "data-radius": h, "data-scaling": m, ref: s$1, ...B, className: y("radix-themes", { light: n === "light", dark: n === "dark" }, B.className) }));
});
